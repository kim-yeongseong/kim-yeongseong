...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=26&pause=1500&color=6366F1&center=true&vCenter=true&width=700&height=44&lines=Full+Stack+Developer+%7C+7%2B+Years;AI+%ED%98%91%EC%97%85+%EA%B0%9C%EB%B0%9C%EC%9E%90;%EB%AC%BC%EB%A5%98%C2%B7%ED%95%B4%EC%9A%B4+%EB%8F%84%EB%A9%94%EC%9D%B8+%EC%A0%84%EB%AC%B8%EA%B0%80;%EB%B3%80%ED%99%94%EC%97%90+%EB%91%90%EB%A0%A4%EC%9B%8C%ED%95%98%EC%A7%80+%EC%95%8A%EB%8A%94%2C+%EA%B6%81%EA%B8%88%EC%A6%9D+%EB%A7%8E%EC%9D%80+%EA%B0%9C%EB%B0%9C%EC%9E%90)](https://git.io/typing-svg)
...
### 🌐 [Portfolio](https://kim-yeongseong.vercel.app) · 🚀 [마이픽 AI](https://mypick-ai.vercel.app) · 📧 [dudtjd7820@naver.com](mailto:dudtjd7820@naver.com)
...
### 🏢 주식회사 국제종합물류
**전산/개발팀 선임연구원** · <code>2024.11 ~ 현재</code>

물류 포워딩 **B2B SaaS 플랫폼(ILIC)** 신규 구축의 풀스택 담당.

- **22개 업무 도메인** · **3개 리포지토리** 단독 운영
- 3명 소수 팀에서 **AI 협업 기반 자동화 워크플로우** 설계·정착
- 기술 문서/기획서/개발 일지 체계를 직접 작성하여 **연구전담부서 지정 기여** · **선임연구원 채택**

`Java 17` · `Spring Boot 3.3.5` · `Vue 3.5` · `TypeScript` · `QueryDSL` · `MySQL` · `Redis` · `SSE`

<br>

## 📋 Experience

**㈜올젠소프트** · <code>2024.08 ~ 2024.11</code>
프리랜서 · NPS 연금 시스템 전자민원 개발

**아로아랩스** · <code>2023.07 ~ 2024.07</code>
개발팀 대리 · Go + Azure 기반 해상물류 시스템 **클린 아키텍처 설계**

**(주)엠피엘에스** · <code>2019.05 ~ 2023.06</code>
솔루션사업팀 대리 · **eCargo** 해상물류 WEB Booking 시스템 (4년 2개월)
...
### 🤖 AI와 함께 일하는 개발자
AI(Claude, Cursor, Copilot 등)를 **"단순 코드 생성기"가 아닌 "함께 리뷰하고 토론하는 협업 파트너"** 로 활용합니다.

회사에 Claude Code 도입을 적극 제안해 승인받고, **CLAUDE.md 공통 컨텍스트 문서 체계**를 3개 리포지토리에 정착시켰습니다.

### 🔍 작은 질문도 끝까지 따라가는 편
작은 이슈 속에서도 **이유와 원인을 끝까지 탐구**하며 더 나은 해결책을 찾습니다.

### 🤝 협업과 의사소통이 핵심
기술적 역량을 갖춘 이후에는 **협업과 의사소통, 함께 고민할 수 있는 역량**이 더 중요하다고 믿습니다.

### 📚 지속적인 학습과 성장
**학점은행제 학사 과정(휴넷·컴퓨터공학과) 진행 중** · **정보처리기사 필기 합격** 후 실기 준비 중
